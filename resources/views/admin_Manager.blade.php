                                            ...
                                            <tr style="font-size: 12px;">
                                                ...
                                                <td><button type="button" style="font-size: 10px;" class="btn btn-info"
                                                    ...
                                                    <button type="button" style="font-size: 10px;"
                                                        ...
                                                        onclick="Conplete_Schedule('{{ $item->prod_id }} ', '{{ $item->email }} ','{{ $item->appointmentSchedule }}')">HT
                                                        lái thử</button>

                                                    <button type="button" style="font-size: 10px;"
                                                        class="btn btn-danger"
                                                        onclick="Cancel_Schedule('{{ $item->prod_id }} ', '{{ $item->email }} ','{{ $item->appointmentSchedule }}')">Hủy</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>

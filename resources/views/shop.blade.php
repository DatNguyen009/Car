            ...
            <div class="latest__card">
                ...
                <div class="pagination">
                    ...
                    @if ($products->currentPage() > 1 && $products->lastPage() > 1)
                        <a class="btn btn-light" href="{{ $products->previousPageUrl() }}">Prev</a>
                    @endif
                    ...
                    @for ($i = 1; $i <= $products->lastPage(); $i++)
                        ...
                        @if ($i == $products->currentPage())
                            <a href="{{ $products->url($i) }}" class="text-center active">
                                <p style="color: #ea2d4e;">{{ $i }}</p>
                            </a>
                        @else
                            <a href="{{ $products->url($i) }}" class="text-center">
                                <p>{{ $i }}</p>
                            </a>
                        @endif
                    ...
                    @if ($products->currentPage() < $products->lastPage())
                        <a class="btn btn-light" href="{{ $products->nextPageUrl() }}">Next</a>
                    @endif
